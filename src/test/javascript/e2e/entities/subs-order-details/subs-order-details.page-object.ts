...
export class SubsOrderDetailsUpdatePage {
  ...
  subsOrderDetailSeqIdInput = element(by.id('field_subsOrderDetailSeqId'));
  ...
  tempSubscriptionProductSeqIdsInput = element(by.id('field_tempSubscriptionProductSeqIds'));
  ...
  async setSubsOrderDetailSeqIdInput(subsOrderDetailSeqId: string): Promise<void> {
    await this.subsOrderDetailSeqIdInput.sendKeys(subsOrderDetailSeqId);
  }

  async getSubsOrderDetailSeqIdInput(): Promise<string> {
    return await this.subsOrderDetailSeqIdInput.getAttribute('value');
  }
  ...
  async setTempSubscriptionProductSeqIdsInput(tempSubscriptionProductSeqIds: string): Promise<void> {
    await this.tempSubscriptionProductSeqIdsInput.sendKeys(tempSubscriptionProductSeqIds);
  }

  async getTempSubscriptionProductSeqIdsInput(): Promise<string> {
    return await this.tempSubscriptionProductSeqIdsInput.getAttribute('value');
  }
