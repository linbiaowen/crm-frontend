...
import { SubscriptionProductComponent } from 'app/entities/subscription-product/subscription-product.component';
...
describe('Component Tests', () => {
  describe('SubscriptionProduct Management Component', () => {
    let comp: SubscriptionProductComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(SubscriptionProductComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      spyOn(service, 'query').and.returnValue(
        of(
          new HttpResponse({
            body: [new SubscriptionProduct('123')],
            headers
          })
        )
      );
      ...
      expect(comp.subscriptionProducts && comp.subscriptionProducts[0]).toEqual(jasmine.objectContaining({ id: '123' }));
    });
