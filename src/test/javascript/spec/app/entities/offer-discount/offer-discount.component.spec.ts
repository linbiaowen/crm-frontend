...
import { OfferDiscountComponent } from 'app/entities/offer-discount/offer-discount.component';
...
describe('Component Tests', () => {
  describe('OfferDiscount Management Component', () => {
    let comp: OfferDiscountComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(OfferDiscountComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.offerDiscounts && comp.offerDiscounts[0]).toEqual(jasmine.objectContaining({ id: '123' }));
    });
