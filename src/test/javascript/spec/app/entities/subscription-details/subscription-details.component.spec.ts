...
import { SubscriptionDetailsComponent } from 'app/entities/subscription-details/subscription-details.component';
...
describe('Component Tests', () => {
  describe('SubscriptionDetails Management Component', () => {
    let comp: SubscriptionDetailsComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(SubscriptionDetailsComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      spyOn(service, 'query').and.returnValue(
        of(
          new HttpResponse({
            body: [new SubscriptionDetails('123')],
            headers
          })
        )
      );
      ...
      expect(comp.subscriptionDetails && comp.subscriptionDetails[0]).toEqual(jasmine.objectContaining({ id: '123' }));
    });
