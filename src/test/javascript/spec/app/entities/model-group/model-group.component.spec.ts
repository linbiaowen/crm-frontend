...
import { ModelGroupComponent } from 'app/entities/model-group/model-group.component';
...
describe('Component Tests', () => {
  describe('ModelGroup Management Component', () => {
    let comp: ModelGroupComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ModelGroupComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.modelGroups && comp.modelGroups[0]).toEqual(jasmine.objectContaining({ id: '123' }));
    });
