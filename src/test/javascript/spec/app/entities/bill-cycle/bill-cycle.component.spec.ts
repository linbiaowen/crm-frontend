...
import { BillCycleComponent } from 'app/entities/bill-cycle/bill-cycle.component';
...
describe('Component Tests', () => {
  describe('BillCycle Management Component', () => {
    let comp: BillCycleComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(BillCycleComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.billCycles && comp.billCycles[0]).toEqual(jasmine.objectContaining({ id: '123' }));
    });
