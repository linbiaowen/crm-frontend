...
import { SubscriptionGroupComponent } from 'app/entities/subscription-group/subscription-group.component';
...
describe('Component Tests', () => {
  describe('SubscriptionGroup Management Component', () => {
    let comp: SubscriptionGroupComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(SubscriptionGroupComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      spyOn(service, 'query').and.returnValue(
        of(
          new HttpResponse({
            body: [new SubscriptionGroup('123')],
            headers
          })
        )
      );
      ...
      expect(comp.subscriptionGroups && comp.subscriptionGroups[0]).toEqual(jasmine.objectContaining({ id: '123' }));
    });
