...
import { ProductDataComponent } from 'app/entities/product-data/product-data.component';
...
describe('Component Tests', () => {
  describe('ProductData Management Component', () => {
    let comp: ProductDataComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ProductDataComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.productData && comp.productData[0]).toEqual(jasmine.objectContaining({ id: '123' }));
    });
