...
import { OfferProductComponent } from 'app/entities/offer-product/offer-product.component';
...
describe('Component Tests', () => {
  describe('OfferProduct Management Component', () => {
    let comp: OfferProductComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(OfferProductComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.offerProducts && comp.offerProducts[0]).toEqual(jasmine.objectContaining({ id: '123' }));
    });
