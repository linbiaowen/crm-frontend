...
import { OfferPromotionComponent } from 'app/entities/offer-promotion/offer-promotion.component';
...
describe('Component Tests', () => {
  describe('OfferPromotion Management Component', () => {
    let comp: OfferPromotionComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(OfferPromotionComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.offerPromotions && comp.offerPromotions[0]).toEqual(jasmine.objectContaining({ id: '123' }));
    });
