...
import { OrderMasterComponent } from 'app/entities/order-master/order-master.component';
...
describe('Component Tests', () => {
  describe('OrderMaster Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.orderMasters && comp.orderMasters[0]).toEqual(jasmine.objectContaining({ id: '123' }));
    });
