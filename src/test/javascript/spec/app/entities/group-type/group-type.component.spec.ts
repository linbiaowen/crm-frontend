...
import { GroupTypeComponent } from 'app/entities/group-type/group-type.component';
...
describe('Component Tests', () => {
  describe('GroupType Management Component', () => {
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(GroupTypeComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.groupTypes && comp.groupTypes[0]).toEqual(jasmine.objectContaining({ id: '123' }));
    });
