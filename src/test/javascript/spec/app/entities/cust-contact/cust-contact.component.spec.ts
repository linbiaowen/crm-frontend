...
import { CustContactComponent } from 'app/entities/cust-contact/cust-contact.component';
...
describe('Component Tests', () => {
  describe('CustContact Management Component', () => {
    let comp: CustContactComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(CustContactComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.custContacts && comp.custContacts[0]).toEqual(jasmine.objectContaining({ id: '123' }));
    });
