...
import { ModelCategoryComponent } from 'app/entities/model-category/model-category.component';
...
describe('Component Tests', () => {
  describe('ModelCategory Management Component', () => {
    let comp: ModelCategoryComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ModelCategoryComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.modelCategories && comp.modelCategories[0]).toEqual(jasmine.objectContaining({ id: '123' }));
    });
