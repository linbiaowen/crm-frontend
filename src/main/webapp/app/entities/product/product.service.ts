...
export class ProductService {
  ...
  protected convertDateFromClient(product: IProduct): IProduct {
    const copy: IProduct = Object.assign({}, product, {
      startDate: product.startDate && product.startDate.isValid() ? product.startDate.toJSON() : undefined,
      endDate: product.endDate && product.endDate.isValid() ? product.endDate.toJSON() : undefined,
      createdDate: product.createdDate && product.createdDate.isValid() ? product.createdDate.toJSON() : undefined,
      lastUpdatedDate: product.lastUpdatedDate && product.lastUpdatedDate.isValid() ? product.lastUpdatedDate.toJSON() : undefined
    });
    return copy;
  }
  ...
  protected convertDateArrayFromServer(res: EntityArrayResponseType): EntityArrayResponseType {
    if (res.body) {
      res.body.forEach((product: IProduct) => {
        product.startDate = product.startDate ? moment(product.startDate) : undefined;
        product.endDate = product.endDate ? moment(product.endDate) : undefined;
        product.createdDate = product.createdDate ? moment(product.createdDate) : undefined;
        product.lastUpdatedDate = product.lastUpdatedDate ? moment(product.lastUpdatedDate) : undefined;
      });
    }
    return res;
  }
